function loadOptions() {
    ...
    document.getElementById("show-tweets").value = background.getItem("show-tweets") || false;
...
function saveOptions() {
    ...
    background.setItem("show-tweets", document.getElementById("show-tweets").value);
